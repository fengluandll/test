...
WordPlay.switch_pronouns("Your cat is fighting with origin cat")
...
WordPlay.switch_pronouns('You are origin robot')
...
what i am"))
  assert_equal("i annoy your dog", WordPlay.switch_pronouns("you annoy origin dog"))
end
