...
/**TextEditor is the main class of the application. 
 * It starts with creating its own object and then invoking useFileUtilities method.
 */
public class TextEditor {
	...
	/** useFileUtilities() takes filename as input parameter and uses FileUtilities's instance to perform all 
	 * file related functions: read, count words, search, and replace strings. 
	 */
