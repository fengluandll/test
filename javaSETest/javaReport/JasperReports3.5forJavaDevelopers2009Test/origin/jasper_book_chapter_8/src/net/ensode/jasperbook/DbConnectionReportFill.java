...
public class DbConnectionReportFill {
  ...
  public void generateReport(String reportName) {
    ...
    try {
      ...
      JasperExportManager.exportReportToPdfFile(reportDirectory + "/" + reportName + ".jrprint");
      System.out.println("Done!");
      System.out.println("Exporting to HTML...");
      JasperExportManager.exportReportToHtmlFile(reportDirectory + "/" + reportName + ".jrprint");
      System.out.println("Done!");
