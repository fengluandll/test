...
public abstract class _RootDAO extends
    net.ensode.jasperbook.dbaccess.base._BaseRootDAO
{
   ...
   * "config-file" which // will be passed in here so you can tell what session
   * factory an individual mapping file // belongs to return (SessionFactory)
   * new InitialContext().lookup("java:/{SessionFactoryName}"); }
   */
}