...
public class ReactorTest {
    ...
    public void testReplayProcessor() {
        ...
        data.subscribe(t -> System.out.println("s1: " + t));
        data.onNext(10L);
        data.onNext(11L);
        data.onNext(12L);
        data.onNext(13L);
        data.onNext(14L);
        data.subscribe(t -> System.out.println("s2: " + t));
    }
    ...
    public void testWorkQueueProcessor() {
        WorkQueueProcessor<Long> data = WorkQueueProcessor
                .<Long>builder().build();
    ...
    public void testColdPublisher() {
        ...
        fibonacciGenerator
                .take(5)
                .subscribe(t -> System.out.println("1. " + t));
        fibonacciGenerator
                .take(5)
                .subscribe(t -> System.out.println("2. " + t));
