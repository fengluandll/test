...
/**
 * This frame contains a combo box to select a shape and a panel to draw it.
 */
class ShapeTestFrame extends JFrame {
	private static final long serialVersionUID = 2999970631137459441L;
...
/**
 * This panel draws a shape and allows the user to move the points that define
 * it.
 */
class ShapePanel extends JPanel {
	private static final long serialVersionUID = 6572362584077652812L;
