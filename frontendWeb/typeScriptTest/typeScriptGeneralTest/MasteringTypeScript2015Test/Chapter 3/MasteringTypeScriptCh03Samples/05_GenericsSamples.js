...
var PersonPrinter = (function () {
    ...
    PersonPrinter.prototype.print = function (arg) {
        console.log("Person born on " + arg.getDateOfBirth() + " is a " + arg.getPersonCategory() + " and is " + this.getPermissionString(arg) + "allowed to sign.");
    };
...
//# sourceMappingURL=05_GenericsSamples.js.map
