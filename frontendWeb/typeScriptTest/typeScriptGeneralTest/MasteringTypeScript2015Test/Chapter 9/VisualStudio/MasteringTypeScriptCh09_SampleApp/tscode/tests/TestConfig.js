...
require(['jasmine-boot', 'BoardSalesApp', 'tinyioc', 'snippetservice', 'text!/tscode/app/views/PageViewLayout.html'], function (jb, app, tinyioc, snippetservice, pageViewLayoutSnippet) {
