...
describe("<ABC> Money Exchange Company: Currency Converter Module, ", function() {
	describe("When Convert Currency Across Region: ", function(){
		...
		//Created new scenario to increase code coverage
		it("Verify that Indian Rupees (INR) " +
				"converted to Us Dollars (USD) " +
				"with Higher Exchange Rate", function() {
			var myCurrency = new CurrencyConverter(10500, "INR", "USD");
			expect(myCurrency.convertedCurrency()).toEqual(193);
		});		
		it("Verify that Indian Rupees (INR) " +
