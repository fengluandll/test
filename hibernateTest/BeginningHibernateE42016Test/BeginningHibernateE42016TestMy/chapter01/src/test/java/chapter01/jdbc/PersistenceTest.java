...
public class PersistenceTest {
    ...
    public void setup() throws ClassNotFoundException {
        ...
        try {
            ...
            ps = connection.prepareStatement("CREATE TABLE messages (" +
    ...
    public void readMessage() {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:hsqldb:db1;shutdown=true")){
